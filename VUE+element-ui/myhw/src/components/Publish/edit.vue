  ...
  <div>
    <el-form ref="form" :model="form" label-width="100px">
      <el-form-item label="出版社编号">
        <el-row>
          <el-col :span="16">
            <el-input v-model="form.id" placeholder="请输入出版社编号"></el-input>
          </el-col>
         <el-col :span="8">
           <el-button type="primary" @click="getInfo()">索引</el-button>
         </el-col>
        </el-row>
  ...
  methods: {
    getInfo(){
      console.log(this.form.id)
        axios.get('http://localhost:8084/pubByIdInfo?id='+this.form.id)
            .then(res=>{
              console.log(res);
    ...
    onSubmit() {
      ...
      axios.post('http://localhost:8084/editPub',{
        "id":this.form.id,
        "name":this.form.name,
