  ...
  methods:{
    ...
    search(){
      ...
      switch (this.search_index){
        case 0:
          axios.get('http://localhost:8084/BorrowAll')
              .then(res=>{
          ...
          break;
        case 1:
          axios.get('http://localhost:8084/BorrowInfoByIndex?bindex='+this.input)
              .then(
                  res=>{
                    console.log(res.data.data);
                    this.tableData=res.data.data;
          ...
          break;
        case 2:
          axios.get('http://localhost:8084/BorrowById?bid='+this.input)
              .then(
                  res=>{
                    console.log(res.data.data);
                    this.tableData=res.data.data;
